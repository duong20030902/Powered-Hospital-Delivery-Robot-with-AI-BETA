...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(slam_dir, 'param', 'slam_toolbox_params.yaml'),
    ...
    #             os.path.join(get_package_share_directory('omni_base_nav'), 'launch', 'rviz_view_launch.py')
    #         )
    #     )
    # )
    # Running SLAM Toolbox (Only one of them will be run)
    ld.add_action(start_slam_toolbox_cmd)
    # ld.add_action(map_saver_cmd)
